...
var ProviderSet = wire.NewSet(NewData, NewOrm, NewRedis, NewKafka, NewSeqClient, NewFavoriteRepo)
...
// NewData .
func NewData(c *conf.Data, orm *gorm.DB, redis *redis.Client, kafka sarama.SyncProducer,
