...
type FavoriteRepo interface {
	...
	GetUserFavoriteVideoIdListByVideoIds(ctx context.Context, userId int64, videoIds []int64) ([]int64, error)
...
func (uc *FavoriteUsecase) GetUserFavoriteVideoIdListByVideoIds(ctx context.Context, userId int64, videoIds []int64) ([]int64, error) {
	return uc.repo.GetUserFavoriteVideoIdListByVideoIds(ctx, userId, videoIds)
}
