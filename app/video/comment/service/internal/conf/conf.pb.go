...
var file_conf_conf_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),           // 0: kratos.account.Bootstrap
	(*Server)(nil),              // 1: kratos.account.Server
	(*Data)(nil),                // 2: kratos.account.Data
	(*Server_HTTP)(nil),         // 3: kratos.account.Server.HTTP
	(*Server_GRPC)(nil),         // 4: kratos.account.Server.GRPC
	(*Data_Database)(nil),       // 5: kratos.account.Data.Database
	(*Data_Redis)(nil),          // 6: kratos.account.Data.Redis
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.account.Bootstrap.server:type_name -> kratos.account.Server
	2,  // 1: kratos.account.Bootstrap.data:type_name -> kratos.account.Data
	3,  // 2: kratos.account.Server.http:type_name -> kratos.account.Server.HTTP
	4,  // 3: kratos.account.Server.grpc:type_name -> kratos.account.Server.GRPC
	5,  // 4: kratos.account.Data.database:type_name -> kratos.account.Data.Database
	6,  // 5: kratos.account.Data.redis:type_name -> kratos.account.Data.Redis
	7,  // 6: kratos.account.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: kratos.account.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: kratos.account.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: kratos.account.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
